  ...
  const leadStatusOptions = useMemo((): FilterOption[] => {
    ...
    return [
      ...
      },
      {
        ...
        label: 'Contacted',
        count: leads.filter(lead => lead.status === LeadStatus.CONTACTED)
          .length,
      },
      {
        value: LeadStatus.QUALIFIED,
        label: 'Qualified',
        count: leads.filter(lead => lead.status === LeadStatus.QUALIFIED)
          .length,
      },
      {
        value: LeadStatus.UNQUALIFIED,
        label: 'Unqualified',
        count: leads.filter(lead => lead.status === LeadStatus.UNQUALIFIED)
          .length,
      },
      {
        value: LeadStatus.CONVERTED,
        label: 'Converted',
        count: leads.filter(lead => lead.status === LeadStatus.CONVERTED)
          .length,
      },
    ];
  }, [state.leads]);
    ...
    return [
      { value: 'all', label: 'All Opportunities', count: opportunities.length },
      {
        ...
        count: opportunities.filter(
          opp => opp.stage === OpportunityStage.PROSPECTING
        ).length,
      },
      {
        ...
        label: 'Qualification',
        count: opportunities.filter(
          opp => opp.stage === OpportunityStage.QUALIFICATION
        ).length,
      },
      {
        ...
        label: 'Proposal',
        count: opportunities.filter(
          opp => opp.stage === OpportunityStage.PROPOSAL
        ).length,
      },
      {
        ...
        label: 'Negotiation',
        count: opportunities.filter(
          opp => opp.stage === OpportunityStage.NEGOTIATION
        ).length,
      },
      {
